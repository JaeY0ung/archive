...
import com.ssafy.los.backend.service.sheet.SheetStarRateService;
...
public class SheetStarRateController {
    ...
    public ResponseEntity<?> updateSheetStarRate(
            @PathVariable("sheet-star-rate-id") Long sheetStarRateId,
            @RequestBody SheetStarRateUpdateDto sheetStarRateUpdateDto) {
        Long updateId = sheetStarRateService.updateSheetStarRate(sheetStarRateId,
                sheetStarRateUpdateDto);
