...
public class SinglePlayController {
    ...
    public ResponseEntity<?> sendIntermediateScoreToPython(@RequestPart(value = "files", required = false) MultipartFile file) {
        String url = "http://localhost8000/fastapi/playing";
