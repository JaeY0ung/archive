        ...
        <div class="flex flex-col gap-10 w-[49%] h-full rounded-xl">
            ...
            <div>
                ...
                <div class="h-full bg-white/50 rounded-xl">
                    <BigSheetCard v-for="sheet in sameLevelSheets" :sheet />
                </div>
            </div>
            ...
            <div>
                ...
                <div class="h-full bg-white/50 rounded-xl flex justify-between">
                    ...
                    <div class="flex flex-1  items-center flex-row gap-3">
                        <div v-for="(starRateCount, index) in starRateStatistic">
                ...
                <div class="flex">
                    ...
                    <input v-model="starRateRegisterForm.starRate" type="range" min="1" max="5" step="1" class="input input-bordered w-full" />
                    {{ starRateRegisterForm.starRate }}
                    <button @click="registerStarRate" class="btn btn-primary">등록</button>
                </div>

                <div class="flex flex-col gap-3">
                    <div class="flex gap-10" v-for="starRateInfo in starRateList" :starRateInfo>
