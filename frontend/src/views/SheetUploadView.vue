...
searchSongsByFilter({ keyword: keyword.value }, ({ data }) => {
if (!data) return;
songs.value = data;
songs.value.map(
    (s) =>
...
<div class="flex flex-col gap-4">
    <label class="form-control flex items-center justify-center w-full">
        ...
        <div class="flex justify-center w-full">
            ...
            type="file" 
            class=" file-input w-[50vw]  border border-gray-300 rounded-lg" 
            ref="fileInput" />
        </div>
    ...
    <input
        ...
        type="text"
        class="w-[50vw] p-2 border border-gray-300 rounded-lg"
    />
    </label>
    ...
    <div class="flex justify-center items-center w-full">
        <div class="flex justify-center items-center w-[50vw] gap-2">
            <label class="w-full">
                ...
                <input
                @submit.prevent="searchSongsByKeyword"
                v-model="keyword"
                type="text"
                class="w-full p-2 border border-gray-300 rounded-lg"
                @input="searchSongsByKeyword"
                placeholder="검색"
                />
            </label>
    ...
    <div
    v-else class="flex w-full h-[100px] overflow-x-scroll cursor-pointer gap-2"
