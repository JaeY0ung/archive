...
<template>
	<div class="w-full h-[85px] m-[5px] p-[5px] flex flex-row justify-between gap-3 bg-white rounded-lg" style="box-shadow: 0px 5px 8px rgba(0, 0, 0, 0.3);">

		<div class="w-full h-full flex justify-start gap-3">
			<!-- (왼쪽) 악보 사진 -->
